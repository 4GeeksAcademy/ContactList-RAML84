    ...
    return (
        <form className="container-fluid" onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
                ...
                <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" className="form-control" id="email" aria-describedby="email" placeholder="Introduce tu correo"/>
            </div>
            <div className="mb-3">
