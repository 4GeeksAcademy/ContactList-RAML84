...
export const AddContact = () => {
	...
	return (
		<form className="container-fluid" onSubmit={handleSubmit}>
			<h1 className="mt-5 mx-auto p-3 text-center text-primary
			...
			<div className="mb-3">
				...
				<input value={address} onChange={(e) => setAddress(e.target.value)} type="text" className="form-control" id="address" aria-describedby="address" placeholder="Introduce aqui tu direccion" />
			</div>
			<div className="mb-3">
